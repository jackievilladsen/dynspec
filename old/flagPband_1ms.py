...
# split command used to create old test data set (4 scans: pcal, src, pcal, bpcal) - YZCMi_3P (actually copied from YZCMi_1)
# split(vis='YZCMi_1P.ms',outputvis='test.ms',scan='21~22,27~28',datacolumn='data')
# now:
# split(vis='../../2/P/YZCMi_2P.ms',outputvis='YZCMi_3P.ms',spw='5~6',datacolumn='data')
...
mstransform(vis=msfile,outputvis=ms_hs,field=bpcal+','+srcname,hanning=True,timeaverage=True,timebin='6s',datacolumn='data')

print 'Flagging zeros (correlator errors)...'
flagdata(vis=ms_hs,mode='clip',clipzeros=True) # zeros indicate correlator malfunction - should be ~1% of data or less
