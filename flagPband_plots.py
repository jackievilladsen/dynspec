...
amax = amp_plot_max(msfile,visstat,datacolumn='corrected',field=bpcal)
bmax = amax * 2.5
...
# the second pass of flagging adds 1-2% more flagged
...
setjy(vis=ms1spw,field=bpcal,standard='Scaife-Heald 2012',model=bpcal+'_L.im') # load bpcal model to acct for structure, spec index
...
# delete corrected_data column to save disk space temporarily
# nope too hard
